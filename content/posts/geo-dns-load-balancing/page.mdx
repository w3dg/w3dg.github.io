export const metadata = {
  title: "GeoDNS Load Balancing | DG Dev",
  description: "How Load Balancing with GeoDNS works to ensure speedy delivery.",
  openGraph: {
    images: [{ url: `https://kage.w3dg.workers.dev/api/og?title=${encodeURIComponent("GeoDNS Load Balancing")}&date=${encodeURIComponent("2025-05-12")}` }],
  },
};

import CoverImage from "@/app/blog/blog-components/cover-image";
import RelativeDate from "@/app/blog/blog-components/relative-date";

import lb from "./lb.png";
import chennai from "./DNS-Chennai.png";
import tokyo from "./DNS-Tokyo.png";

# One website, multiple IPs closer to you - Load Balancing with GeoDNS
<RelativeDate date="2025-05-12" />

<CoverImage src={lb} alt="" />
...
<CoverImage src={chennai} alt="Ping Response normally resolves to 142.250.206.14" />
...
<CoverImage src={tokyo} alt="Ping Response with VPN set to Tokyo resolves to 142.250.199.110" />

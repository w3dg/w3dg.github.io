+++
date = '2024-05-02T12:55:42+05:30'
draft = false
...
I noticed _one_ of my professors during this semester at my university that he had ditched Windows completely! And gone full linux on his laptop. Many seniors I see also have done the same. So it felt like a right time to actually go into Linux. Already I was using some WSL2, Git Bash and other hacks to get Linux like feeling on windows but I finally left all that baggage behind and sat in one sitting from the afternoon and installed Ubuntu 24.04.
...
The list can be found [here](https://gist.github.com/w3dg/7896f7a69ce250b706a29b1ac495664a) for my future reference and maybe even yours. I have also taken the base version of [my dotfiles](https://github.com/w3dg/dotfiles)  and then tweaked it to match Ubuntu's as I dont see myself going back to Windows anytime soon.

## Thoughts after the process

The entire process was very easy actually. Just you need some time and good internet. Most software, as I said, were already cross platform available so I didn't have many hiccups. Except _Whatsapp_ and _Notion_ which I may have to use web clients for. ( Or even look into FOSS alternatives :p).

Some notable mentions are [auto-cpufreq](https://github.com/AdnanHodzic/auto-cpufreq) - this helps to keep your cpu speed according to your battery life and actually have a good battery life. I have this running and can easily go about 5-6 hours which I got before as well while on Windows. In addition, [thermald](https://wiki.debian.org/thermald) is also mentioned on the internet.
